...
var $author$project$Models$Assignment = F7(
	function (id, courseId, creator, title, description, dueDate, fromMoodle) {
		return {courseId: courseId, creator: creator, description: description, dueDate: dueDate, fromMoodle: fromMoodle, id: id, title: title};
	});
					...
					A2(
						...
						function (a) {
							return A5(
								...
								color,
								assignmentHovered,
								_Utils_eq(user.id, a.creator.id),
								displayDate,
								a);
						},
						assignments))
