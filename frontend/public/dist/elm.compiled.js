...
var $author$project$Api$Api$localApiAddress = 'http://localhost:8004';
		...
		return $elm$http$Http$riskyRequest(
			{
				...
				expect: A2($author$project$Api$expectJson, options.onResponse, $author$project$Api$Homework$Course$courseDecoder),
				headers: _List_Nil,
				method: 'POST',
				timeout: $elm$core$Maybe$Nothing,
				tracker: $elm$core$Maybe$Nothing,
