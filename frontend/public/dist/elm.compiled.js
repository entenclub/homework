	...
	function (shared, url) {
		return _Utils_Tuple2(
			...
			function () {
				...
				if (_v0.$ === 'Just') {
					var user = _v0.a;
					return $elm$core$Platform$Cmd$batch($author$project$Pages$Dashboard$initCommands);
				} else {
					return A2($author$project$Utils$Route$navigate, url.key, $author$project$Spa$Generated$Route$Login);
				}
			}());
	});
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 'CreateAssignment':
				var _v2 = model.selectedCourse;
				if (_v2.$ === 'Just') {
					var course = _v2.a;
					var _v3 = model.selectedDate;
					if (_v3.$ === 'Just') {
						var dueDate = _v3.a;
						return _Utils_Tuple2(
							_Utils_update(
