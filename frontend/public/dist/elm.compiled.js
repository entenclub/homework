...
{
	if (region.ep.b6 === region.e0.b6)
	{
		return 'on line ' + region.ep.b6;
	}
	return 'on lines ' + region.ep.b6 + ' through ' + region.e0.b6;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { hH: 'hidden', g2: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { hH: 'mozHidden', g2: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { hH: 'msHidden', g2: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { hH: 'webkitHidden', g2: 'webkitvisibilitychange' }
		: { hH: 'hidden', g2: 'visibilitychange' };
}
...
{
	return {
		f2: _Browser_getScene(),
		gn: {
			gs: _Browser_window.pageXOffset,
			gu: _Browser_window.pageYOffset,
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		function done(response) {
			callback(toTask(request.e3.a(response)));
		}

		var xhr = new XMLHttpRequest();
		xhr.addEventListener('error', function() { done($elm$http$Http$NetworkError_); });
		xhr.addEventListener('timeout', function() { done($elm$http$Http$Timeout_); });
		xhr.addEventListener('load', function() { done(_Http_toResponse(request.e3.b, xhr)); });
		$elm$core$Maybe$isJust(request.gg) && _Http_track(router, xhr, request.gg.a);

		try {
			xhr.open(request.fy, request.gj, true);
		} catch (e) {
			return done($elm$http$Http$BadUrl_(request.gj));
		}
...
{
	for (var headers = request.fc; headers.b; headers = headers.b) // WHILE_CONS
	{
		xhr.setRequestHeader(headers.a.a, headers.a.b);
	}
	xhr.timeout = request.gf.a || 0;
	xhr.responseType = request.e3.d;
...
function _Http_toMetadata(xhr)
{
	return {
		...
		eq: xhr.status,
		i_: xhr.statusText,
		fc: _Http_parseHeaders(xhr.getAllResponseHeaders())
	};
}
...
function _Http_track(router, xhr, tracker)
{
	...
	xhr.addEventListener('progress', function(event) {
		...
		_Scheduler_rawSpawn(A2($elm$core$Platform$sendToSelf, router, _Utils_Tuple2(tracker, $elm$http$Http$Receiving({
			iz: event.loaded,
			f5: event.lengthComputable ? $elm$core$Maybe$Just(event.total) : $elm$core$Maybe$Nothing
		}))));
	});
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {e8: fragment, ff: host, fO: path, fQ: port_, fU: protocol, eb: query};
	});
...
var $elm$url$Url$Parser$State = F5(
	function (visited, unvisited, params, frag, value) {
		return {a9: frag, iu: params, a3: unvisited, aE: value, bk: visited};
	});
		...
		return $elm$url$Url$Parser$getFirstMatch(
			parser(
				A5(
					...
					_List_Nil,
					$elm$url$Url$Parser$preparePath(url.fO),
...
var $author$project$Shared$classifyDevice = function (options) {
	return (options.jB < 900) ? A4($author$project$Shared$Device, 0, 0, options.jB, options.hF) : ((options.jB < 1400) ? A4($author$project$Shared$Device, 1, 0, options.jB, options.hF) : A4($author$project$Shared$Device, 2, 1, options.jB, options.hF));
};
				...
				switch (response.$) {
					...
					case 3:
						...
						if (!_v1.$) {
							var value = _v1.a;
							return $elm$core$Result$Err(
								A2($author$project$Api$BadStatus, metadata.eq, value));
						} else {
							var err = _v1.a;
							return $elm$core$Result$Err(
								A2(
...
var $elm$http$Http$onEffects = F4(
	function (router, cmds, subs, state) {
		return A2(
			...
			A3($elm$http$Http$updateReqs, router, cmds, state.fX));
	});
			...
			return $elm$http$Http$Request(
				{
					gJ: r.gJ,
					eO: r.eO,
					e3: A2(_Http_mapExpect, func, r.e3),
					fc: r.fc,
					fy: r.fy,
					gf: r.gf,
					gg: r.gg,
...
var $elm$http$Http$riskyRequest = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{gJ: true, eO: r.eO, e3: r.e3, fc: r.fc, fy: r.fy, gf: r.gf, gg: r.gg, gj: r.gj}));
};
var $author$project$Models$User = F5(
	function (id, username, email, privilege, moodleUrl) {
		return {e$: email, hK: id, h5: moodleUrl, ix: privilege, eA: username};
	});
...
var $author$project$Api$Homework$User$getUserFromSession = function (options) {
	return $elm$http$Http$riskyRequest(
		{
			eO: $elm$http$Http$emptyBody,
			e3: A2($author$project$Api$expectJson, options.fH, $author$project$Api$Homework$User$userDecoder),
			fc: _List_Nil,
			fy: 'GET',
			gf: $elm$core$Maybe$Nothing,
			gg: $elm$core$Maybe$Nothing,
			gj: $author$project$Api$Api$apiAddress + '/user'
		});
};
		...
		return _Utils_Tuple2(
			A4(
				...
				$author$project$Shared$classifyDevice(
					{hF: flags.hF, jB: flags.jB})),
			$author$project$Api$Homework$User$getUserFromSession(
				{fH: $author$project$Shared$GotUser}));
	});
...
var $author$project$Models$Course = F7(
	function (id, name, subject, teacher, assignments, fromMoodle, creator) {
		return {gN: assignments, eV: creator, hB: fromMoodle, hK: id, h6: name, i2: subject, i8: teacher};
	});
var $author$project$Models$Assignment = F7(
	function (id, courseId, creator, title, description, dueDate, fromMoodle) {
		return {hd: courseId, eV: creator, hl: description, ho: dueDate, hB: fromMoodle, hK: id, jn: title};
	});
...
var $elm$parser$Parser$Advanced$DeadEnd = F4(
	function (row, col, problem, contextStack) {
		return {eT: col, hb: contextStack, fR: problem, f_: row};
	});
...
var $elm$parser$Parser$Advanced$fromState = F2(
	function (s, x) {
		return A2(
			...
			A4($elm$parser$Parser$Advanced$DeadEnd, s.f_, s.eT, x, s.f));
	});
	...
	function (isGood, expecting) {
		return function (s) {
			...
			return _Utils_eq(newOffset, -1) ? A2(
				...
				true,
				0,
				{eT: 1, f: s.f, k: s.k, b: s.b + 1, f_: s.f_ + 1, a: s.a}) : A3(
				$elm$parser$Parser$Advanced$Good,
				true,
				0,
				{eT: s.eT + 1, f: s.f, k: s.k, b: newOffset, f_: s.f_, a: s.a}));
		};
	});
...
var $elm$parser$Parser$Advanced$token = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, str, s.b, s.f_, s.eT, s.a);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			...
			progress,
			0,
			{eT: newCol, f: s.f, k: s.k, b: newOffset, f_: newRow, a: s.a});
	};
};
...
var $elm$parser$Parser$DeadEnd = F3(
	function (row, col, problem) {
		return {eT: col, fR: problem, f_: row};
	});
var $elm$parser$Parser$problemToDeadEnd = function (p) {
	return A3($elm$parser$Parser$DeadEnd, p.f_, p.eT, p.fR);
};
...
var $elm$parser$Parser$Advanced$run = F2(
	function (_v0, src) {
		var parse = _v0;
		var _v1 = parse(
			{eT: 1, f: _List_Nil, k: 1, b: 0, f_: 1, a: src});
		if (!_v1.$) {
			var value = _v1.b;
			return $elm$core$Result$Ok(value);
		} else {
	...
	return $elm$http$Http$riskyRequest(
		{
			...
			gf: $elm$core$Maybe$Nothing,
			gg: $elm$core$Maybe$Nothing,
			gj: $author$project$Api$Api$apiAddress + '/courses/active'
		});
};
...
var $author$project$Pages$Dashboard$initCommands = _List_fromArray(
	[
		...
		{fH: $author$project$Pages$Dashboard$GotCourseData}),
...
var $author$project$Pages$Dashboard$init = F2(
	function (shared, url) {
		return _Utils_Tuple2(
			{
				a4: 0,
				hc: $author$project$Api$NotAsked,
...
var $justinmimbs$date$Date$toCalendarDate = function (_v0) {
	...
	return A3($justinmimbs$date$Date$toCalendarDateHelp, date.gv, 0, date.dY);
};
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					...
					0,
					{eT: col, f: s0.f, k: s0.k, b: offset, f_: row, a: s0.a});
			} else {
...
var $elm$parser$Parser$Advanced$chompWhile = function (isGood) {
	return function (s) {
		return A5($elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.b, s.f_, s.eT, s);
	};
};
...
var $justinmimbs$date$Date$language_en = {
	...
	eB: $justinmimbs$date$Date$weekdayToName,
	bl: A2(
		$elm$core$Basics$composeR,
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'course',
				$elm$json$Json$Encode$int(assignment.hd)),
				_Utils_Tuple2(
				'dueDate',
				$elm$json$Json$Encode$string(
					$author$project$Api$Homework$Assignment$dateEncoder(assignment.ho))),
				_Utils_Tuple2(
				'fromMoodle',
				$elm$json$Json$Encode$bool(assignment.hB))
			]));
};
		...
		return $elm$http$Http$riskyRequest(
			{
				...
				e3: A2($author$project$Api$expectJson, options.fH, $author$project$Api$Homework$Course$assignmentDecoder),
				fc: _List_Nil,
				fy: 'POST',
				gf: $elm$core$Maybe$Nothing,
				gg: $elm$core$Maybe$Nothing,
				gj: $author$project$Api$Api$apiAddress + '/assignment'
			});
	});
...
var $elm$time$Time$toDay = F2(
	function (zone, time) {
		return $elm$time$Time$toCivil(
			A2($elm$time$Time$toAdjustedMinutes, zone, time)).eW;
	});
...
var $elm$time$Time$toYear = F2(
	function (zone, time) {
		return $elm$time$Time$toCivil(
			A2($elm$time$Time$toAdjustedMinutes, zone, time)).gv;
	});
		...
		return $elm$http$Http$riskyRequest(
			{
				...
				gf: $elm$core$Maybe$Nothing,
				gg: $elm$core$Maybe$Nothing,
				gj: $author$project$Api$Api$apiAddress + ('/assignment?id=' + $elm$core$String$fromInt(id))
			});
	});
var $author$project$Api$Homework$Course$MinimalCourse = F5(
	function (id, name, subject, teacher, fromMoodle) {
		return {hB: fromMoodle, hK: id, h6: name, i2: subject, i8: teacher};
	});
		...
		return $elm$http$Http$riskyRequest(
			{
				...
				gf: $elm$core$Maybe$Nothing,
				gg: $elm$core$Maybe$Nothing,
				gj: $author$project$Api$Api$apiAddress + ('/courses/search/' + searchterm)
			});
	});
	...
	function (msg, model) {
		switch (msg.$) {
				...
				if (data.$ === 2) {
					...
					if (e.$ === 3) {
						...
						return ((s === 401) || (s === 403)) ? _Utils_Tuple2(
							model,
							A2($author$project$Utils$Route$navigate, model.gj.hY, 2)) : _Utils_Tuple2(
							_Utils_update(
								model,
								{hc: data}),
							$elm$core$Platform$Cmd$none);
			...
			case 1:
				return _Utils_Tuple2(
					model,
					A2($author$project$Utils$Route$navigate, model.gj.hY, 5));
			case 2:
				var text = msg.a;
				...
				return $elm$core$String$isEmpty(
					...
					A2(
						...
						text,
						{fH: $author$project$Pages$Dashboard$GotSearchCoursesData})) : _Utils_Tuple2(
					_Utils_update(
						model,
						{
							d: A2(
					...
					A2(
						$author$project$Api$Homework$Course$searchCourses,
						text,
						{fH: $author$project$Pages$Dashboard$GotSearchCoursesData})));
			case 4:
				var course = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							d: A2(
								...
								model.d),
							aZ: $author$project$Api$NotAsked,
							aA: course.hB ? course.h6 : (course.i8 + (': ' + course.i2)),
					...
					if (!_v5.$) {
						...
						return _Utils_Tuple2(
							...
							A2(
								...
								{hd: course.hK, ho: dueDate, hB: course.hB, jn: model.a0},
								{fH: $author$project$Pages$Dashboard$GotCreateAssignmentData}));
					} else {
			...
			case 11:
				...
				return _Utils_Tuple2(
					...
					A2(
						...
						id,
						{fH: $author$project$Pages$Dashboard$GotRemoveAssignmentData}));
			case 12:
				var data = msg.a;
				if (data.$ === 3) {
												...
												return _Utils_update(
													c,
													{
														gN: A2(
															$elm$core$List$filter,
															function (a) {
																return !_Utils_eq(a.hK, assignment.hK);
															},
															c.gN)
													});
											},
...
var $mdgriffith$elm_ui$Internal$Model$asColumn = 1;
var $mdgriffith$elm_ui$Internal$Style$classes = {gx: 'a', gy: 'atv', gB: 'ab', gC: 'cx', gD: 'cy', gE: 'acb', gF: 'accx', gG: 'accy', gH: 'acr', eJ: 'al', eK: 'ar', gI: 'at', db: 'ah', dc: 'av', gL: 's', gR: 'bh', gS: 'b', gU: 'w7', gW: 'bd', gX: 'bdt', cu: 'bn', gY: 'bs', cy: 'cpe', g5: 'cp', g6: 'cpx', g7: 'cpy', aL: 'c', cA: 'ctr', cC: 'cb', cD: 'ccx', aM: 'ccy', bV: 'cl', cE: 'cr', ha: 'ct', he: 'cptr', hf: 'ctxt', hz: 'fcs', e6: 'focus-within', hC: 'fs', hE: 'g', dt: 'hbh', du: 'hc', fd: 'he', dv: 'hf', fe: 'hfp', hI: 'hv', hL: 'ic', hN: 'fr', cO: 'lbl', hR: 'iml', hS: 'imlf', hT: 'imlp', hU: 'implw', hV: 'it', hX: 'i', fv: 'lnk', bB: 'nb', fD: 'notxt', ij: 'ol', il: 'or', bb: 'oq', it: 'oh', az: 'pg', fM: 'p', iv: 'ppe', iG: 'ui', f_: 'r', iM: 'sb', iN: 'sbx', iO: 'sby', iQ: 'sbt', iU: 'e', iV: 'cap', iW: 'sev', i1: 'sk', et: 't', i9: 'tc', ja: 'w8', jb: 'w2', jc: 'w9', jd: 'tj', c6: 'tja', je: 'tl', jf: 'w3', jg: 'w5', jh: 'w4', ji: 'tr', jj: 'w6', jk: 'w1', jl: 'tun', aa: 'ts', bj: 'clr', jw: 'u', eC: 'wc', gq: 'we', eD: 'wf', gr: 'wfp', eE: 'wrp'};
var $mdgriffith$elm_ui$Internal$Model$Generic = {$: 0};
var $mdgriffith$elm_ui$Internal$Model$div = $mdgriffith$elm_ui$Internal$Model$Generic;
var $mdgriffith$elm_ui$Internal$Model$NoNearbyChildren = {$: 0};
var $mdgriffith$elm_ui$Internal$Model$columnClass = $mdgriffith$elm_ui$Internal$Style$classes.gL + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.aL);
var $mdgriffith$elm_ui$Internal$Model$gridClass = $mdgriffith$elm_ui$Internal$Style$classes.gL + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.hE);
var $mdgriffith$elm_ui$Internal$Model$pageClass = $mdgriffith$elm_ui$Internal$Style$classes.gL + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.az);
var $mdgriffith$elm_ui$Internal$Model$paragraphClass = $mdgriffith$elm_ui$Internal$Style$classes.gL + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.fM);
var $mdgriffith$elm_ui$Internal$Model$rowClass = $mdgriffith$elm_ui$Internal$Style$classes.gL + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.f_);
var $mdgriffith$elm_ui$Internal$Model$singleClass = $mdgriffith$elm_ui$Internal$Style$classes.gL + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.iU);
	...
	switch (style.$) {
		...
		case 8:
			...
			return 'grid-rows-' + (A2(
				$elm$core$String$join,
				'-',
				A2($elm$core$List$map, $mdgriffith$elm_ui$Internal$Model$lengthClassName, template.iH)) + ('-cols-' + (A2(
				$elm$core$String$join,
				'-',
				A2($elm$core$List$map, $mdgriffith$elm_ui$Internal$Model$lengthClassName, template.ar)) + ('-space-x-' + ($mdgriffith$elm_ui$Internal$Model$lengthClassName(template.iX.a) + ('-space-y-' + $mdgriffith$elm_ui$Internal$Model$lengthClassName(template.iX.b)))))));
		case 9:
			var pos = style.a;
			return 'gp grid-pos-' + ($elm$core$String$fromInt(pos.f_) + ('-' + ($elm$core$String$fromInt(pos.eT) + ('-' + ($elm$core$String$fromInt(pos.jB) + ('-' + $elm$core$String$fromInt(pos.hF)))))));
		case 11:
...
var $mdgriffith$elm_ui$Internal$Model$formatBoxShadow = function (shadow) {
	return A2(
		...
		A2(
			...
			_List_fromArray(
				[
					shadow.fk ? $elm$core$Maybe$Just('inset') : $elm$core$Maybe$Nothing,
					$elm$core$Maybe$Just(
					...
					$elm$core$Maybe$Just(
					$elm$core$String$fromFloat(shadow.f5) + 'px'),
					$elm$core$Maybe$Just(
...
var $mdgriffith$elm_ui$Internal$Model$renderFocusStyle = function (focus) {
	return _List_fromArray(
		[
			...
			$mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.e6) + ':focus-within',
			A2(
				$elm$core$List$filterMap,
				$elm$core$Basics$identity,
				_List_fromArray(
		...
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.hI, $mdgriffith$elm_ui$Internal$Style$classes.bj)) + ':hover',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.hI, $mdgriffith$elm_ui$Internal$Style$classes.bb)) + ':hover',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.hz, $mdgriffith$elm_ui$Internal$Style$classes.bj)) + ':focus',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.hz, $mdgriffith$elm_ui$Internal$Style$classes.bb)) + ':focus',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.gy, $mdgriffith$elm_ui$Internal$Style$classes.bj)) + ':active',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.gy, $mdgriffith$elm_ui$Internal$Style$classes.bb)) + ':active',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
...
var $mdgriffith$elm_ui$Internal$Style$overrides = '@media screen and (-ms-high-contrast: active), (-ms-high-contrast: none) {' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.gL) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.f_) + (' > ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.gL) + (' { flex-basis: auto !important; } ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.gL) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.f_) + (' > ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.gL) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.cA) + (' { flex-basis: auto !important; }}' + ($mdgriffith$elm_ui$Internal$Style$inputTextReset + ($mdgriffith$elm_ui$Internal$Style$sliderReset + ($mdgriffith$elm_ui$Internal$Style$trackReset + ($mdgriffith$elm_ui$Internal$Style$thumbReset + $mdgriffith$elm_ui$Internal$Style$explainer)))))))))))))));
...
var $mdgriffith$elm_ui$Internal$Model$hasSmallCaps = function (typeface) {
	if (typeface.$ === 5) {
		var font = typeface.a;
		return A2($elm$core$List$any, $mdgriffith$elm_ui$Internal$Model$isSmallCaps, font.gl);
	} else {
		return false;
	}
};
	...
	if (typeface.$ === 5) {
		...
		return $elm$core$Maybe$Just(
			A2(
				$elm$core$String$join,
				', ',
				A2($elm$core$List$map, $mdgriffith$elm_ui$Internal$Model$renderVariant, font.gl)));
	} else {
		return $elm$core$Maybe$Nothing;
	}
};
	...
	function (options, rule, maybePseudo) {
		switch (rule.$) {
			...
			case 5:
				...
				var single = '.' + $mdgriffith$elm_ui$Internal$Style$classes.iU;
				var row = '.' + $mdgriffith$elm_ui$Internal$Style$classes.f_;
				var wrappedRow = '.' + ($mdgriffith$elm_ui$Internal$Style$classes.eE + row);
				var right = '.' + $mdgriffith$elm_ui$Internal$Style$classes.eK;
				var paragraph = '.' + $mdgriffith$elm_ui$Internal$Style$classes.fM;
			...
			case 8:
				...
				var xSpacing = toGridLength(template.iX.a);
				var ySpacing = toGridLength(template.iX.b);
				var rows = function (x) {
					...
					A2(
						$elm$core$String$join,
						' ',
						A2($elm$core$List$map, toGridLength, template.iH)));
				...
				var msColumns = function (x) {
					...
					A2(
						...
						ySpacing,
						A2($elm$core$List$map, toGridLength, template.ar)));
				var gapY = 'grid-row-gap:' + (toGridLength(template.iX.b) + ';');
				var gapX = 'grid-column-gap:' + (toGridLength(template.iX.a) + ';');
			...
			case 9:
				...
				var msPosition = A2(
					...
					_List_fromArray(
						[
							'-ms-grid-row: ' + ($elm$core$String$fromInt(position.f_) + ';'),
							'-ms-grid-row-span: ' + ($elm$core$String$fromInt(position.hF) + ';'),
							'-ms-grid-column: ' + ($elm$core$String$fromInt(position.eT) + ';'),
				...
				var modernPosition = A2(
					...
					_List_fromArray(
						[
							'grid-row: ' + ($elm$core$String$fromInt(position.f_) + (' / ' + ($elm$core$String$fromInt(position.f_ + position.hF) + ';'))),
							'grid-column: ' + ($elm$core$String$fromInt(position.eT) + (' / ' + ($elm$core$String$fromInt(position.eT + position.jB) + ';')))
						]));
				var _class = '.grid-pos-' + ($elm$core$String$fromInt(position.f_) + ('-' + ($elm$core$String$fromInt(position.eT) + ('-' + ($elm$core$String$fromInt(position.jB) + ('-' + $elm$core$String$fromInt(position.hF)))))));
...
var $mdgriffith$elm_ui$Internal$Model$renderFontAdjustmentRule = F3(
	function (fontToAdjust, _v0, otherFontName) {
		...
		return A2(
			...
			' ',
			_Utils_ap(
				A3($mdgriffith$elm_ui$Internal$Model$fontRule, name, $mdgriffith$elm_ui$Internal$Style$classes.iV, capital),
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					'.' + (name + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.iV + (', ' + ('.' + (name + (' .' + $mdgriffith$elm_ui$Internal$Style$classes.iV))))))),
					_List_fromArray(
						[
					...
					A2(
					$mdgriffith$elm_ui$Internal$Model$bracket,
					'.' + (name + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.iV + ('> .' + ($mdgriffith$elm_ui$Internal$Style$classes.et + (', .' + (name + (' .' + ($mdgriffith$elm_ui$Internal$Style$classes.iV + (' > .' + $mdgriffith$elm_ui$Internal$Style$classes.et)))))))))),
					_List_fromArray(
						[
...
var $mdgriffith$elm_ui$Internal$Model$adjust = F3(
	function (size, height, vertical) {
		return {hF: height / size, f5: size, gm: vertical};
	});
...
var $mdgriffith$elm_ui$Internal$Model$convertAdjustment = function (adjustment) {
	var lines = _List_fromArray(
		[adjustment.g0, adjustment.gQ, adjustment.hk, adjustment.h0]);
	var lineHeight = 1.5;
	...
	return {
		g0: A3($mdgriffith$elm_ui$Internal$Model$adjust, capitalSize, ascender - newBaseline, capitalVertical),
	...
	return _Utils_Tuple2(
		...
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'line-height',
				$elm$core$String$fromFloat(converted.hF)),
				_Utils_Tuple2(
				'vertical-align',
					...
					return A3(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class($mdgriffith$elm_ui$Internal$Style$classes.gL + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.iU))
									]))
							]));
			}
		}();
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.gL, $mdgriffith$elm_ui$Internal$Style$classes.iU, $mdgriffith$elm_ui$Internal$Style$classes.cA, $mdgriffith$elm_ui$Internal$Style$classes.aM, $mdgriffith$elm_ui$Internal$Style$classes.gH])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.gL, $mdgriffith$elm_ui$Internal$Style$classes.iU, $mdgriffith$elm_ui$Internal$Style$classes.cA, $mdgriffith$elm_ui$Internal$Style$classes.aM, $mdgriffith$elm_ui$Internal$Style$classes.gF])))
						]),
					_List_fromArray(
						[html])) : html));
			case 1:
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.gL, $mdgriffith$elm_ui$Internal$Style$classes.iU, $mdgriffith$elm_ui$Internal$Style$classes.cA, $mdgriffith$elm_ui$Internal$Style$classes.gG])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.gL, $mdgriffith$elm_ui$Internal$Style$classes.iU, $mdgriffith$elm_ui$Internal$Style$classes.cA, $mdgriffith$elm_ui$Internal$Style$classes.gE])))
						]),
					_List_fromArray(
						[html])) : html));
			default:
...
var $mdgriffith$elm_ui$Internal$Model$textElementClasses = $mdgriffith$elm_ui$Internal$Style$classes.gL + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.et + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.eC + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.du)))));
...
var $mdgriffith$elm_ui$Internal$Model$textElementFillClasses = $mdgriffith$elm_ui$Internal$Style$classes.gL + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.et + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.eD + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.dv)))));
...
var $mdgriffith$elm_ui$Internal$Model$createElement = F3(
	function (context, children, rendered) {
					...
					case 1:
						...
						return _Utils_eq(context, $mdgriffith$elm_ui$Internal$Model$asParagraph) ? _Utils_Tuple2(
							A2(
								...
								_Utils_Tuple2(
									key,
									A2(styled.hJ, $mdgriffith$elm_ui$Internal$Model$NoStyleSheet, context)),
								htmls),
							$elm$core$List$isEmpty(existingStyles) ? styled.gb : _Utils_ap(styled.gb, existingStyles)) : _Utils_Tuple2(
							A2(
								$elm$core$List$cons,
								_Utils_Tuple2(
									key,
									A2(styled.hJ, $mdgriffith$elm_ui$Internal$Model$NoStyleSheet, context)),
								htmls),
							$elm$core$List$isEmpty(existingStyles) ? styled.gb : _Utils_ap(styled.gb, existingStyles));
					case 2:
						var str = child.a;
						return _Utils_Tuple2(
							A2(
		...
		if (children.$ === 1) {
			...
			var keyed = _v1.a;
			var styles = _v1.b;
			var newStyles = $elm$core$List$isEmpty(styles) ? rendered.gb : _Utils_ap(rendered.gb, styles);
			if (!newStyles.b) {
				return $mdgriffith$elm_ui$Internal$Model$Unstyled(
					A5(
						...
						$mdgriffith$elm_ui$Internal$Model$Keyed(
							A3($mdgriffith$elm_ui$Internal$Model$addKeyedChildren, 'nearby-element-pls', keyed, rendered.g3)),
				...
				return $mdgriffith$elm_ui$Internal$Model$Unstyled(
					A5(
						...
						$mdgriffith$elm_ui$Internal$Model$Unkeyed(
							A2($mdgriffith$elm_ui$Internal$Model$addChildren, unkeyed, rendered.g3)),
						$mdgriffith$elm_ui$Internal$Model$NoStyleSheet));
			} else {
				var allStyles = newStyles;
				return $mdgriffith$elm_ui$Internal$Model$Styled(
						...
						switch (location) {
							case 0:
								return A2(
									...
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.bB, $mdgriffith$elm_ui$Internal$Style$classes.iU, $mdgriffith$elm_ui$Internal$Style$classes.gx]));
							case 1:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.bB, $mdgriffith$elm_ui$Internal$Style$classes.iU, $mdgriffith$elm_ui$Internal$Style$classes.gS]));
							case 2:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.bB, $mdgriffith$elm_ui$Internal$Style$classes.iU, $mdgriffith$elm_ui$Internal$Style$classes.il]));
							case 3:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.bB, $mdgriffith$elm_ui$Internal$Style$classes.iU, $mdgriffith$elm_ui$Internal$Style$classes.ij]));
							case 4:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.bB, $mdgriffith$elm_ui$Internal$Style$classes.iU, $mdgriffith$elm_ui$Internal$Style$classes.hN]));
							default:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.bB, $mdgriffith$elm_ui$Internal$Style$classes.iU, $mdgriffith$elm_ui$Internal$Style$classes.gR]));
						}
					}())
				]),
			_List_fromArray(
				[
					...
					switch (elem.$) {
						...
						default:
							var styled = elem.a;
							return A2(styled.hJ, $mdgriffith$elm_ui$Internal$Model$NoStyleSheet, $mdgriffith$elm_ui$Internal$Model$asEl);
					}
				}()
				]));
	});
...
var $mdgriffith$elm_ui$Internal$Model$alignXName = function (align) {
	switch (align) {
		...
		case 2:
			return $mdgriffith$elm_ui$Internal$Style$classes.db + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.eK);
		default:
			return $mdgriffith$elm_ui$Internal$Style$classes.db + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.gC);
	}
};
var $mdgriffith$elm_ui$Internal$Model$alignYName = function (align) {
	switch (align) {
		case 0:
			return $mdgriffith$elm_ui$Internal$Style$classes.dc + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.gI);
		case 2:
			return $mdgriffith$elm_ui$Internal$Style$classes.dc + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.gB);
		default:
			return $mdgriffith$elm_ui$Internal$Style$classes.dc + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.gD);
	}
};
	...
	switch (h.$) {
		case 0:
			...
			return _Utils_Tuple3(
				...
				$mdgriffith$elm_ui$Internal$Style$classes.fd + (' ' + name),
				_List_fromArray(
					[
		...
		case 2:
			...
			return (portion === 1) ? _Utils_Tuple3(
				...
				A2($mdgriffith$elm_ui$Internal$Flag$add, $mdgriffith$elm_ui$Internal$Flag$heightFill, $mdgriffith$elm_ui$Internal$Flag$none),
				$mdgriffith$elm_ui$Internal$Style$classes.fe + (' height-fill-' + $elm$core$String$fromInt(portion)),
				_List_fromArray(
					[
						A3(
						$mdgriffith$elm_ui$Internal$Model$Single,
						$mdgriffith$elm_ui$Internal$Style$classes.gL + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.aL + (' > ' + $mdgriffith$elm_ui$Internal$Style$dot(
...
var $mdgriffith$elm_ui$Internal$Model$renderWidth = function (w) {
	switch (w.$) {
		case 0:
			...
			return _Utils_Tuple3(
				$mdgriffith$elm_ui$Internal$Flag$none,
				$mdgriffith$elm_ui$Internal$Style$classes.gq + (' width-px-' + $elm$core$String$fromInt(px)),
				_List_fromArray(
					[
						A3(
						$mdgriffith$elm_ui$Internal$Model$Single,
		...
		case 2:
			...
			return (portion === 1) ? _Utils_Tuple3(
				...
				_List_Nil) : _Utils_Tuple3(
				A2($mdgriffith$elm_ui$Internal$Flag$add, $mdgriffith$elm_ui$Internal$Flag$widthFill, $mdgriffith$elm_ui$Internal$Flag$none),
				$mdgriffith$elm_ui$Internal$Style$classes.gr + (' width-fill-' + $elm$core$String$fromInt(portion)),
				_List_fromArray(
					[
						A3(
						$mdgriffith$elm_ui$Internal$Model$Single,
						$mdgriffith$elm_ui$Internal$Style$classes.gL + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.f_ + (' > ' + $mdgriffith$elm_ui$Internal$Style$dot(
					...
					case 7:
						...
						if (A2($mdgriffith$elm_ui$Internal$Flag$present, $mdgriffith$elm_ui$Internal$Flag$width, has)) {
							...
							switch (width.$) {
								case 0:
									var px = width.a;
									var $temp$classes = ($mdgriffith$elm_ui$Internal$Style$classes.gq + (' width-px-' + $elm$core$String$fromInt(px))) + (' ' + classes),
										$temp$node = node,
								...
								case 2:
									...
									if (portion === 1) {
										...
										var $temp$classes = classes + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.gr + (' width-fill-' + $elm$core$String$fromInt(portion)))),
											$temp$node = node,
											$temp$has = A2(
											$mdgriffith$elm_ui$Internal$Flag$add,
											$mdgriffith$elm_ui$Internal$Flag$widthFill,
						...
						if (A2($mdgriffith$elm_ui$Internal$Flag$present, $mdgriffith$elm_ui$Internal$Flag$height, has)) {
							...
							switch (height.$) {
								case 0:
									...
									var name = 'height-px-' + val;
									var $temp$classes = $mdgriffith$elm_ui$Internal$Style$classes.fd + (' ' + (name + (' ' + classes))),
										$temp$node = node,
								...
								case 2:
									...
									if (portion === 1) {
										...
										var $temp$classes = classes + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.fe + (' height-fill-' + $elm$core$String$fromInt(portion)))),
											$temp$node = node,
											$temp$has = A2(
											$mdgriffith$elm_ui$Internal$Flag$add,
											$mdgriffith$elm_ui$Internal$Flag$heightFill,
					...
					case 9:
						...
						var newStyles = function () {
							switch (elem.$) {
								...
								default:
									var styled = elem.a;
									return _Utils_ap(styles, styled.gb);
							}
						}();
						var $temp$classes = classes,
							$temp$node = node,
...
var $mdgriffith$elm_ui$Element$column = F2(
	function (attrs, children) {
		return A4(
			...
			A2(
				$elm$core$List$cons,
				$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.ha + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bV)),
				A2(
					$elm$core$List$cons,
...
var $mdgriffith$elm_ui$Element$Font$italic = $mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.hX);
...
var $mdgriffith$elm_ui$Element$Font$bold = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$fontWeight, $mdgriffith$elm_ui$Internal$Style$classes.gU);
...
var $mdgriffith$elm_ui$Element$pointer = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$cursor, $mdgriffith$elm_ui$Internal$Style$classes.he);
		...
		return A4(
			...
			A2(
				...
				A2(
					...
					A2(
						$elm$core$List$cons,
						$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.cD + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.aM + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.iQ + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.fD)))))),
						A2(
							$elm$core$List$cons,
...
var $mdgriffith$elm_ui$Element$Border$dotted = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$borderStyle, $mdgriffith$elm_ui$Internal$Style$classes.gX);
...
var $mdgriffith$elm_ui$Element$clip = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$overflow, $mdgriffith$elm_ui$Internal$Style$classes.g5);
...
var $mdgriffith$elm_ui$Element$Input$negateBox = function (box) {
	return {gZ: -box.gZ, h_: -box.h_, iF: -box.iF, jv: -box.jv};
};
				...
				_Utils_ap(
					_List_fromArray(
						[
							...
							$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.fD + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.iv)),
...
var $mdgriffith$elm_ui$Element$scrollbarY = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$overflow, $mdgriffith$elm_ui$Internal$Style$classes.iO);
...
var $mdgriffith$elm_ui$Element$Input$textHelper = F3(
	function (textInput, attrs, textOptions) {
		...
		var redistributed = A3(
			...
			$mdgriffith$elm_ui$Element$Input$isStacked(textOptions.hZ),
			withDefaults);
				...
				_Utils_ap(
					_List_fromArray(
						[
							...
							$mdgriffith$elm_ui$Element$Input$hiddenLabelAttribute(textOptions.hZ),
					...
					_Utils_ap(
						(heightConstrained ? $elm$core$List$cons($mdgriffith$elm_ui$Element$scrollbarY) : $elm$core$Basics$identity)(
							_List_fromArray(
								[
									$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
									A2($elm$core$List$any, $mdgriffith$elm_ui$Element$Input$hasFocusStyle, withDefaults) ? $mdgriffith$elm_ui$Internal$Model$NoAttribute : $mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.e6),
											...
											return _List_fromArray(
												[
													...
													A2(
														...
														_List_fromArray(
															[
																$elm$html$Html$Attributes$class($mdgriffith$elm_ui$Internal$Style$classes.hS)
															]),
														_List_fromArray(
															[
		...
		return A3(
			...
			A2(
				$elm$core$List$cons,
				A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$cursor, $mdgriffith$elm_ui$Internal$Style$classes.hf),
				A2(
					$elm$core$List$cons,
					$mdgriffith$elm_ui$Element$Input$isHiddenLabel(textOptions.hZ) ? $mdgriffith$elm_ui$Internal$Model$NoAttribute : $mdgriffith$elm_ui$Element$spacing(5),
				...
				[
					...
					A2(
						...
						_List_fromArray(
							[
								$mdgriffith$elm_ui$Element$text(
								course.hB ? course.h6 : (course.i8 + (': ' + course.i2)))
							])))
				]));
	});
var $author$project$Pages$Dashboard$courseToKeyValue = F2(
	function (last, course) {
		return _Utils_Tuple2(
			$elm$core$String$fromInt(course.hK),
			A2(
				$author$project$Pages$Dashboard$viewSearchDropdownElement,
				course,
				_Utils_eq(course.hK, last.hK)));
	});
	...
	function (unit, n, _v0) {
		...
		switch (unit) {
			...
			case 1:
				...
				var wholeMonths = ((12 * (date.gv - 1)) + ($justinmimbs$date$Date$monthToNumber(date.fA) - 1)) + n;
	...
	function (today, courses) {
		...
		return A2(
				...
				return _Utils_update(
					course,
					{
						gN: A2(
							$elm$core$List$filter,
							function (a) {
								return _Utils_eq(a.hd, course.hK);
							},
							validAssignments)
					});
			},
			A2(
				$elm$core$List$filter,
				function (course) {
					return A2($elm$core$List$member, course.hK, validCourseIds);
				},
				courses));
	});
		...
		return A2(
			...
			_List_fromArray(
				[
						...
						if (!maybeHovered.$) {
							...
							return _Utils_ap(
								_List_fromArray(
									[
										$mdgriffith$elm_ui$Element$Events$onClick(
										$author$project$Pages$Dashboard$RemoveAssignment(assignment.hK))
									]),
								A2(
									$elm$core$List$cons,
									$mdgriffith$elm_ui$Element$Events$onMouseEnter(
										$author$project$Pages$Dashboard$HoverAssignment(assignment.hK)),
									A2(
										$elm$core$List$cons,
										$mdgriffith$elm_ui$Element$Events$onMouseLeave(
											$author$project$Pages$Dashboard$DeHoverAssignment(assignment.hK)),
					...
					A2(
						...
						_List_fromArray(
							[
								$mdgriffith$elm_ui$Element$text(
								_Utils_ap(
									displayDate ? ($author$project$Pages$Dashboard$toGermanDateString(assignment.ho) + ': ') : '',
									_Utils_ap(
										assignment.jn,
										function () {
											if (!maybeHovered.$) {
					...
					$mdgriffith$elm_ui$Element$text(assignment.eV.eA))
				]));
	});
	...
	function (color, maybeHoveredId, removable, displayDate, assignment) {
		if (!maybeHoveredId.$) {
			...
			return removable ? _Utils_Tuple2(
				$elm$core$String$fromInt(assignment.hK),
				A4(
					$author$project$Pages$Dashboard$viewAssignment,
					assignment,
					color,
					$elm$core$Maybe$Just(
						_Utils_eq(hoveredId, assignment.hK)),
		...
		var assignments = function () {
			if (!maybeDate.$) {
				...
				return A2(
					$elm$core$List$filter,
					function (assignment) {
						return _Utils_eq(assignment.ho, date);
					},
					course.gN);
			} else {
				return course.gN;
		...
		var validCourses = A2(
			...
			A2(
				...
				A2(
					$elm$core$List$map,
					function (course) {
						return _Utils_Tuple2(course.hK, course.gN);
					},
					courses)));
		return A2(
			$elm$core$List$filter,
			function (course) {
				return A2($elm$core$List$member, course.hK, validCourses);
			},
			courses);
	});
			...
			[
				...
				function () {
					...
					if (!_v1.$) {
						...
						return _List_fromArray(
							[
								A6($author$project$Pages$Dashboard$viewAssignmentsDayColumn, model.hc, 'today', $author$project$Styling$Colors$redColor, model.D, model.aP, user),
								A6(
				...
				if (_v2.$ === 3) {
					...
					if ($elm$core$List$length(
						...
						if (!_v3.$) {
							var user = _v3.a;
							return A4($author$project$Pages$Dashboard$viewOtherAssignments, model.hc, model.D, model.aP, user);
						} else {
							return $mdgriffith$elm_ui$Element$none;
						}
					} else {
				...
				A2(
					...
					A2(
						...
						A2(
							...
							A2(
								$elm$core$List$cons,
								$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.cD + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.aM + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.fv)))),
								attrs))))),
			$mdgriffith$elm_ui$Internal$Model$Unkeyed(
				_List_fromArray(
					[label])));
		...
		return A2(
			...
			A2(
					...
					[$mdgriffith$elm_ui$Element$centerY]),
				{
					...
					gj: $author$project$Spa$Generated$Route$toString(linkData.b)
				}));
	});
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				($elm$core$String$length(user.eA) > 12) ? $mdgriffith$elm_ui$Element$text(
					'Hey, ' + (A3($elm$core$String$slice, 0, 12, user.eA) + '...')) : $mdgriffith$elm_ui$Element$text('Hey, ' + user.eA)),
				A2(
				$mdgriffith$elm_ui$Element$el,
				_List_Nil,
				function () {
...
var $author$project$Components$Sidebar$viewSidebar = function (model) {
	...
	return A2(
		...
		_List_fromArray(
			[
				A2($author$project$Components$Sidebar$viewUser, model.jy, model.hc),
				A2(
				$mdgriffith$elm_ui$Element$el,
				_List_fromArray(
					[
				...
				A2($author$project$Components$Sidebar$viewLinks, links, model.gy))
			]));
};
	...
	function (attrs, children) {
		...
		if (spaced.$ === 1) {
			return A4(
				...
				A2(
					$elm$core$List$cons,
					$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.bV + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.aM + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.eE)))),
					A2(
						$elm$core$List$cons,
						$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$shrink),
						A2(
				...
				A2(
					...
					_List_fromArray(
						[
							...
							{
								gy: $elm$core$Maybe$Just('dashboard'),
								hc: model.hc,
								hm: model.hm,
								jy: model.jy
							}),
...
var $author$project$Pages$Dashboard$page = $author$project$Spa$Page$application(
	{hQ: $author$project$Pages$Dashboard$init, h$: $author$project$Pages$Dashboard$load, iI: $author$project$Pages$Dashboard$save, i3: $author$project$Pages$Dashboard$subscriptions, jx: $author$project$Pages$Dashboard$update, jz: $author$project$Pages$Dashboard$view});
		...
		return $elm$http$Http$riskyRequest(
			{
				...
				e3: A2($author$project$Api$expectJson, options.fH, $author$project$Api$Homework$Course$courseDecoder),
				fc: _List_Nil,
				fy: 'POST',
				gf: $elm$core$Maybe$Nothing,
				gg: $elm$core$Maybe$Nothing,
		...
		return $elm$http$Http$riskyRequest(
			{
				...
				gf: $elm$core$Maybe$Nothing,
				gg: $elm$core$Maybe$Nothing,
				gj: $author$project$Api$Api$apiAddress + ('/courses/' + ($elm$core$String$fromInt(id) + '/enroll'))
			});
	});
			...
			case 3:
				return _Utils_Tuple2(
					...
					A3(
						...
						model.bf,
						model.bg,
						{fH: $author$project$Pages$Dashboard$Courses$GotCreateCourseResponse}));
			case 4:
				var data = msg.a;
				if (data.$ === 3) {
					var course = data.a;
					...
					if (!_v4.$) {
						...
						return _Utils_Tuple2(
							...
							A2(
								...
								id,
								{fH: $author$project$Pages$Dashboard$Courses$GotEnrollData}));
					} else {
						return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
					}
				} else {
										...
										]) : _List_Nil)),
							{
								hZ: A2(
									...
									_List_fromArray(
										[$mdgriffith$elm_ui$Element$centerX, $mdgriffith$elm_ui$Element$centerY]),
									$mdgriffith$elm_ui$Element$text('create course')),
								fG: $elm$core$List$isEmpty(model.y) ? $elm$core$Maybe$Just($author$project$Pages$Dashboard$Courses$CreateCourse) : $elm$core$Maybe$Nothing
							});
					}()
					]))
			]));
			...
			[
				...
				return A2(
								...
								]) : _List_Nil)),
					{
						...
						fG: active ? $elm$core$Maybe$Just($author$project$Pages$Dashboard$Courses$EnrollInCourse) : $elm$core$Maybe$Nothing
					});
			}()
			]));
};
...
var $author$project$Pages$Dashboard$Courses$viewCourseRow = function (course) {
	return A2(
		...
		course.hB ? _List_fromArray(
			[
				$mdgriffith$elm_ui$Element$text(course.h6)
			]) : _List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Element$text(
					A3($author$project$Pages$Dashboard$Courses$generateInviteCode, course.hK, course.i8, course.i2)))
			]));
};
				...
				A2(
					...
					_List_fromArray(
						[
							$author$project$Components$Sidebar$viewSidebar(
							{
								gy: $elm$core$Maybe$Just('courses'),
								hc: model.hc,
								hm: model.hm,
								jy: model.jy
							}),
							...
							_List_fromArray(
								[
									...
									$author$project$Pages$Dashboard$Courses$viewMyCourses(model.hc)
								]))
						])))
			]),
...
var $author$project$Pages$Dashboard$Courses$page = $author$project$Spa$Page$application(
	{hQ: $author$project$Pages$Dashboard$Courses$init, h$: $author$project$Pages$Dashboard$Courses$load, iI: $author$project$Pages$Dashboard$Courses$save, i3: $author$project$Pages$Dashboard$Courses$subscriptions, jx: $author$project$Pages$Dashboard$Courses$update, jz: $author$project$Pages$Dashboard$Courses$view});
var $author$project$Pages$Dashboard$Moodle$init = F2(
	function (shared, url) {
		return _Utils_Tuple2(
			{bR: $author$project$Api$NotAsked, hc: $author$project$Api$NotAsked, hm: shared.hm, aR: '', aS: $author$project$Api$NotAsked, b7: '', aT: '', gj: url, jy: shared.jy},
			$elm$core$Platform$Cmd$none);
	});
		...
		return $elm$http$Http$riskyRequest(
			{
				...
				gf: $elm$core$Maybe$Nothing,
				gg: $elm$core$Maybe$Nothing,
				gj: $author$project$Api$Api$apiAddress + '/moodle/authenticate'
			});
	});
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{gJ: false, eO: r.eO, e3: r.e3, fc: r.fc, fy: r.fy, gf: r.gf, gg: r.gg, gj: r.gj}));
};
var $elm$http$Http$post = function (r) {
	return $elm$http$Http$request(
		{eO: r.eO, e3: r.e3, fc: _List_Nil, fy: 'POST', gf: $elm$core$Maybe$Nothing, gg: $elm$core$Maybe$Nothing, gj: r.gj});
};
		...
		return $elm$http$Http$post(
			{
				...
				e3: A2($author$project$Api$expectJson, options.fH, $author$project$Api$Moodle$Moodle$decoder),
				gj: 'https://api.hausis.3nt3.de/moodle/get-school-info'
			});
	});
			...
			case 0:
				...
				return _Utils_Tuple2(
					...
					A2(
						...
						text,
						{fH: $author$project$Pages$Dashboard$Moodle$GotSiteData}));
			case 1:
				var data = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
			...
			case 4:
				return _Utils_Tuple2(
					...
					A4(
						...
						model.aT,
						model.aR,
						{fH: $author$project$Pages$Dashboard$Moodle$GotAuthenticationData}));
			default:
				var data = msg.a;
		...
		return A3(
			$mdgriffith$elm_ui$Element$Input$textHelper,
			{
				...
				E: $mdgriffith$elm_ui$Element$Input$TextInputNode(
					pass.iT ? 'text' : 'password')
			},
			attrs,
			{hZ: pass.hZ, dX: pass.dX, d9: pass.d9, et: pass.et});
	});
				...
				A2(
					...
					_List_fromArray(
						[
							$author$project$Components$Sidebar$viewSidebar(
							{
								gy: $elm$core$Maybe$Just('moodle integration'),
								hc: model.hc,
								hm: model.hm,
								jy: model.jy
							}),
...
var $author$project$Pages$Dashboard$Moodle$page = $author$project$Spa$Page$application(
	{hQ: $author$project$Pages$Dashboard$Moodle$init, h$: $author$project$Pages$Dashboard$Moodle$load, iI: $author$project$Pages$Dashboard$Moodle$save, i3: $author$project$Pages$Dashboard$Moodle$subscriptions, jx: $author$project$Pages$Dashboard$Moodle$update, jz: $author$project$Pages$Dashboard$Moodle$view});
var $author$project$Pages$Login$init = F2(
	function (_v0, url) {
		return _Utils_Tuple2(
			{bv: $author$project$Api$NotAsked, cc: '', gj: url, co: ''},
			$elm$core$Platform$Cmd$none);
	});
		...
		return $elm$http$Http$riskyRequest(
			{
				...
				gf: $elm$core$Maybe$Nothing,
				gg: $elm$core$Maybe$Nothing,
				gj: $author$project$Api$Api$apiAddress + '/user/login'
			});
	});
				...
				if (data.$ === 3) {
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{bv: data}),
						A2($author$project$Utils$Route$navigate, model.gj.hY, 1));
				} else {
					return _Utils_Tuple2(
						_Utils_update(
							model,
			...
			default:
				return _Utils_Tuple2(
					...
					A2(
						...
						{e$: $elm$core$Maybe$Nothing, d8: model.cc, eA: model.co},
						{fH: $author$project$Pages$Login$GotLoginData}));
		}
	});
								...
								[
									...
									_List_fromArray(
										[
											...
											{
												hZ: $mdgriffith$elm_ui$Element$Input$labelHidden('username'),
									...
									_List_fromArray(
										[
											...
											{
												hZ: $mdgriffith$elm_ui$Element$Input$labelHidden('password'),
									...
									{
										hZ: $author$project$Pages$Login$viewLoginButton(model),
...
var $author$project$Pages$Login$page = $author$project$Spa$Page$application(
	{hQ: $author$project$Pages$Login$init, h$: $author$project$Pages$Login$load, iI: $author$project$Pages$Login$save, i3: $author$project$Pages$Login$subscriptions, jx: $author$project$Pages$Login$update, jz: $author$project$Pages$Login$view});
...
var $author$project$Pages$Register$init = F2(
	function (_v0, url) {
		return _Utils_Tuple2(
			{
				b1: '',
				d: {e$: $elm$core$Maybe$Nothing, d8: $elm$core$Maybe$Nothing, eA: $elm$core$Maybe$Nothing},
				cc: '',
		...
		return $elm$http$Http$riskyRequest(
			{
				...
				gf: $elm$core$Maybe$Nothing,
				gg: $elm$core$Maybe$Nothing,
				gj: $author$project$Api$Api$apiAddress + '/user/register'
			});
	});
...
var $elm$http$Http$get = function (r) {
	return $elm$http$Http$request(
		{eO: $elm$http$Http$emptyBody, e3: r.e3, fc: _List_Nil, fy: 'GET', gf: $elm$core$Maybe$Nothing, gg: $elm$core$Maybe$Nothing, gj: r.gj});
};
var $author$project$Api$Homework$UsernameTaken$usernameTaken = F2(
	function (username, options) {
		return $elm$http$Http$get(
			{
				e3: A2($author$project$Api$expectJson, options.fH, $elm$json$Json$Decode$bool),
				gj: $author$project$Api$Api$apiAddress + ('/username-taken/' + username)
			});
	});
			...
			case 0:
				...
				return ($elm$core$String$length(input) > 0) ? _Utils_Tuple2(
					...
					A2(
						...
						input,
						{fH: $author$project$Pages$Register$GotUsernameTaken})) : _Utils_Tuple2(
					_Utils_update(
						model,
						{
							d: A2(
			...
			default:
				return $author$project$Pages$Register$areErrorsEmpty(model.d) ? _Utils_Tuple2(
					...
					A2(
						...
						{
							e$: $elm$core$Maybe$Just(model.b1),
							d8: model.cc,
							eA: model.co
						},
						{fH: $author$project$Pages$Register$GotRegistrationData})) : _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
		}
	});
...
var $author$project$Pages$Register$viewInputError = F2(
	function (model, inputName) {
		return (inputName === 'email') ? $author$project$Pages$Register$inputErrorMessage(model.d.e$) : ((inputName === 'username') ? $author$project$Pages$Register$inputErrorMessage(model.d.eA) : ((inputName === 'password') ? $author$project$Pages$Register$inputErrorMessage(model.d.d8) : $mdgriffith$elm_ui$Element$none));
	});
						...
						A2(
							...
							_List_fromArray(
								[
										...
										[
											...
											_List_fromArray(
												[
													...
													{
														hZ: $mdgriffith$elm_ui$Element$Input$labelHidden('email'),
									...
									{
										hZ: $mdgriffith$elm_ui$Element$Input$labelHidden('validate password'),
									...
									{
										hZ: $author$project$Pages$Register$viewRegistrationButton(model),
...
var $author$project$Pages$Register$page = $author$project$Spa$Page$application(
	{hQ: $author$project$Pages$Register$init, h$: $author$project$Pages$Register$load, iI: $author$project$Pages$Register$save, i3: $author$project$Pages$Register$subscriptions, jx: $author$project$Pages$Register$update, jz: $author$project$Pages$Register$view});
...
var $author$project$Spa$Generated$Pages$upgrade = F3(
	function (toModel, toMsg, page) {
			...
			function (params, shared) {
				return A3(
					...
					A2(
						page.hQ,
						shared,
						A3($author$project$Spa$Url$create, params, shared.hY, shared.gj)));
			});
		...
		return {aq: bundle_, hQ: init_, jx: update_};
	});
...
var $author$project$Spa$Generated$Pages$init = function (route) {
	switch (route) {
		case 0:
			return $author$project$Spa$Generated$Pages$pages.jv.hQ(0);
		case 1:
			return $author$project$Spa$Generated$Pages$pages.cG.hQ(0);
		case 2:
			return $author$project$Spa$Generated$Pages$pages.cU.hQ(0);
		case 3:
			return $author$project$Spa$Generated$Pages$pages.cY.hQ(0);
		case 4:
			return $author$project$Spa$Generated$Pages$pages.c2.hQ(0);
		case 5:
			return $author$project$Spa$Generated$Pages$pages.cH.hQ(0);
		default:
			return $author$project$Spa$Generated$Pages$pages.cI.hQ(0);
	}
};
...
var $elm$browser$Browser$Events$onSelfMsg = F3(
	function (router, _v0, state) {
		...
		var messages = A2($elm$core$List$filterMap, toMessage, state.gc);
		return A2(
			$elm$core$Task$andThen,
			function (_v1) {
				return $elm$core$Task$succeed(state);
...
var $mdgriffith$elm_ui$Internal$Model$optionsToRecord = function (options) {
				...
				case 0:
					...
					if (_v4.$ === 1) {
						return _Utils_update(
							record,
							{
								hI: $elm$core$Maybe$Just(hoverable)
							});
					} else {
						return record;
					}
	...
	return andFinally(
		A3(
			$elm$core$List$foldr,
			combine,
			{hz: $elm$core$Maybe$Nothing, hI: $elm$core$Maybe$Nothing, h4: $elm$core$Maybe$Nothing},
			options));
};
			...
			A2(
				...
				$mdgriffith$elm_ui$Internal$Model$htmlClass(
					A2(
						...
						' ',
						_List_fromArray(
							[$mdgriffith$elm_ui$Internal$Style$classes.iG, $mdgriffith$elm_ui$Internal$Style$classes.gL, $mdgriffith$elm_ui$Internal$Style$classes.iU]))),
...
var $author$project$Spa$Generated$Pages$load = function (model) {
	return $author$project$Spa$Generated$Pages$bundle(model).h$(0);
};
var $author$project$Spa$Generated$Pages$save = function (model) {
	return $author$project$Spa$Generated$Pages$bundle(model).iI(0);
};
...
var $author$project$Api$Homework$User$logout = function (options) {
	return $elm$http$Http$riskyRequest(
		{
			eO: $elm$http$Http$emptyBody,
			e3: $elm$http$Http$expectWhatever(options.fH),
			fc: _List_Nil,
			fy: 'POST',
			gf: $elm$core$Maybe$Nothing,
			gg: $elm$core$Maybe$Nothing,
			gj: $author$project$Api$Api$apiAddress + '/user/logout'
		});
};
			...
			case 1:
				return _Utils_Tuple2(
					...
					$author$project$Api$Homework$User$logout(
						{fH: $author$project$Shared$GotLogoutData}));
			case 2:
				var w = msg.a;
				var h = msg.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							hm: $author$project$Shared$classifyDevice(
								{hF: h, jB: w})
						}),
					$elm$core$Platform$Cmd$none);
			default:
...
var $author$project$Main$main = $elm$browser$Browser$application(
	{
		hQ: $author$project$Main$init,
		im: $author$project$Main$UrlChanged,
		$9: $author$project$Main$LinkClicked,
