		...
		return $elm$http$Http$riskyRequest(
			{
				...
				timeout: $elm$core$Maybe$Nothing,
				tracker: $elm$core$Maybe$Nothing,
				url: $author$project$Api$Api$apiAddress + ('/assignment?id=' + $elm$core$String$fromInt(id))
			});
	});
					...
					if (_v5.$ === 'Just') {
						...
						return _Utils_Tuple2(
							...
							A2(
								...
								{courseId: course, dueDate: dueDate, title: model.titleTfText},
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						A5($author$project$Pages$Dashboard$viewAssignmentsDayColumn, model.courseData, 'today', $author$project$Styling$Colors$redColor, model.today, model.maybeAssignmentHovered),
						A5(
				...
				if (_v1.$ === 'Success') {
					...
					return ($elm$core$List$length(
						A2($author$project$Pages$Dashboard$otherOutstandingAssignments, model.today, courses)) > 0) ? A3($author$project$Pages$Dashboard$viewOtherAssignments, model.courseData, model.today, model.maybeAssignmentHovered) : $mdgriffith$elm_ui$Element$none;
				} else {
					return $mdgriffith$elm_ui$Element$none;
				}
			}()
