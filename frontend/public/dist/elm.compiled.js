...
var $author$project$Spa$Generated$Route$Dashboard__Courses = {$: 'Dashboard__Courses'};
...
var $author$project$Spa$Generated$Route$routes = $elm$url$Url$Parser$oneOf(
	_List_fromArray(
		[
			...
			A2(
			$elm$url$Url$Parser$map,
			$author$project$Spa$Generated$Route$Dashboard__Courses,
			A2(
...
var $author$project$Pages$Dashboard$GotCourseAnalyticsData = function (a) {
	return {$: 'GotCourseAnalyticsData', a: a};
};
...
var $author$project$Models$Course = F7(
	function (id, name, subject, teacher, assignments, fromMoodle, creator) {
		return {assignments: assignments, creator: creator, fromMoodle: fromMoodle, id: id, name: name, subject: subject, teacher: teacher};
	});
var $author$project$Models$Assignment = F6(
	function (id, courseId, creator, title, description, dueDate) {
		return {courseId: courseId, creator: creator, description: description, dueDate: dueDate, id: id, title: title};
	});
...
var $author$project$Api$Homework$Analytics$courseAnalyticsDecoder = A3(
	$elm$json$Json$Decode$map2,
	$elm$core$Tuple$pair,
	A2($elm$json$Json$Decode$index, 0, $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$index, 1, $elm$json$Json$Decode$int));
var $author$project$Api$Homework$Analytics$getCourseAnalytics = function (options) {
	return $elm$http$Http$riskyRequest(
		{
			body: $elm$http$Http$emptyBody,
			expect: A2(
				...
				A2(
					...
					_List_fromArray(
						['content']),
					$elm$json$Json$Decode$list($author$project$Api$Homework$Analytics$courseAnalyticsDecoder))),
			headers: _List_Nil,
			method: 'GET',
			timeout: $elm$core$Maybe$Nothing,
			tracker: $elm$core$Maybe$Nothing,
			url: $author$project$Api$Api$apiAddress + '/analytics/courses?tuples'
		});
};
...
var $author$project$Pages$Dashboard$initCommands = _List_fromArray(
	[
		...
		$author$project$Api$Homework$Analytics$getCourseAnalytics(
		{onResponse: $author$project$Pages$Dashboard$GotCourseAnalyticsData}),
...
var $author$project$Pages$Dashboard$init = F2(
	function (shared, url) {
		return _Utils_Tuple2(
			{
				addDaysDifference: 0,
				courseAnalyticsData: $author$project$Api$NotAsked,
...
var $author$project$Pages$Dashboard$load = F2(
	function (shared, model) {
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{device: shared.device, gotUser: true, user: shared.user}),
			$elm$core$Platform$Cmd$none);
	});
...
var $author$project$Api$Homework$Course$MinimalCourse = F5(
	function (id, name, subject, teacher, fromMoodle) {
		return {fromMoodle: fromMoodle, id: id, name: name, subject: subject, teacher: teacher};
	});
		...
		switch (msg.$) {
			case 'GotCourseData':
				...
				if (data.$ === 'Failure') {
					...
					if (e.$ === 'BadStatus') {
						var s = e.a;
						return ((s === 401) || ((s === 403) && model.gotUser)) ? _Utils_Tuple2(
							model,
			...
			case 'GotSearchCoursesData':
				...
				return _Utils_Tuple2(
					...
					$elm$core$Platform$Cmd$none);
			case 'ViewMoreAssignments':
				return _Utils_Tuple2(
					model,
					A2($author$project$Utils$Route$navigate, model.url.key, $author$project$Spa$Generated$Route$Dashboard__Courses));
			case 'SearchCourses':
				var text = msg.a;
					...
					_Utils_update(
						model,
						{
							errors: A2(
								...
								model.errors),
							searchCoursesData: $author$project$Api$NotAsked,
							searchCoursesText: course.fromMoodle ? course.name : (course.teacher + (': ' + course.subject)),
							selectedCourse: $elm$core$Maybe$Just(course.id),
					...
					if (_v5.$ === 'Just') {
						...
						return _Utils_Tuple2(
							...
							A2(
								...
								{courseId: course, dueDate: dueDate, fromMoodle: model.selectedCourseFromMoodle, title: model.titleTfText},
...
var $author$project$Components$CourseChart$colors = $elm$core$Array$fromList(
	_List_fromArray(
		[
			A3($avh4$elm_color$Color$rgb255, 152, 171, 198),
			A3($avh4$elm_color$Color$rgb255, 138, 137, 166),
			A3($avh4$elm_color$Color$rgb255, 123, 104, 136),
			A3($avh4$elm_color$Color$rgb255, 107, 72, 107),
			A3($avh4$elm_color$Color$rgb255, 159, 92, 85),
			A3($avh4$elm_color$Color$rgb255, 208, 116, 60),
			A3($avh4$elm_color$Color$rgb255, 255, 96, 0)
		]));
...
var $author$project$Components$CourseChart$h = 504;
...
var $author$project$Components$CourseChart$w = 990;
var $author$project$Components$CourseChart$radius = A2($elm$core$Basics$min, $author$project$Components$CourseChart$w, $author$project$Components$CourseChart$h) / 2;
...
var $author$project$Components$CourseChart$view = function (model) {
	var pieData = A2(
		$gampleman$elm_visualization$Shape$pie,
		_Utils_update(
			$gampleman$elm_visualization$Shape$defaultPieConfig,
			{outerRadius: $author$project$Components$CourseChart$radius}),
		A2(
			$elm$core$List$map,
			$elm$core$Basics$toFloat,
					...
					[
						...
						$elm_community$typed_svg$TypedSvg$Types$Paint(
							A2(
								...
								A2($elm$core$Array$get, index, $author$project$Components$CourseChart$colors)))),
	...
	var makeLabel = F2(
		function (slice, _v1) {
			...
			var _v0 = $gampleman$elm_visualization$Shape$centroid(
				_Utils_update(
					slice,
					{innerRadius: $author$project$Components$CourseChart$radius - 40, outerRadius: $author$project$Components$CourseChart$radius - 40}));
			var x = _v0.a;
			var y = _v0.b;
			return A2(
	...
	return A2(
		...
		_List_fromArray(
			[
				A4($elm_community$typed_svg$TypedSvg$Attributes$viewBox, 0, 0, $author$project$Components$CourseChart$w, $author$project$Components$CourseChart$h)
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								A2($elm_community$typed_svg$TypedSvg$Types$Translate, $author$project$Components$CourseChart$w / 2, $author$project$Components$CourseChart$h / 2)
							]))
					]),
				_List_fromArray(
					[
				...
				[
					...
					A2(
						...
						_List_fromArray(
							[
								$mdgriffith$elm_ui$Element$text(
								course.fromMoodle ? course.name : (course.teacher + (': ' + course.subject)))
							])))
				]));
	});
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						A4($author$project$Pages$Dashboard$viewAssignmentsDayColumn, model.courseData, 'today', $author$project$Styling$Colors$redColor, model.today),
						A4(
								...
								[
									...
									_List_fromArray(
										[
											...
											function () {
												var _v3 = model.courseAnalyticsData;
												switch (_v3.$) {
													case 'Success':
														var courseData = _v3.a;
														return A2(
															$mdgriffith$elm_ui$Element$el,
															_List_fromArray(
																[
															...
															$mdgriffith$elm_ui$Element$html(
																$author$project$Components$CourseChart$view(courseData)));
													case 'Failure':
														var e = _v3.a;
														return A2(
															$mdgriffith$elm_ui$Element$el,
...
var $author$project$Pages$Dashboard$Courses$init = F2(
	function (shared, url) {
		return _Utils_Tuple2(
			{
				courseData: $author$project$Api$NotAsked,
				createCourseErrors: _List_fromArray(
...
var $author$project$Pages$Dashboard$Courses$save = F2(
	function (model, shared) {
		return (!_Utils_eq(model.user, $elm$core$Maybe$Nothing)) ? _Utils_update(
			shared,
			{user: model.user}) : shared;
	});
		...
		return $elm$http$Http$riskyRequest(
			{
				...
				timeout: $elm$core$Maybe$Nothing,
				tracker: $elm$core$Maybe$Nothing,
				url: $author$project$Api$Api$apiAddress + ('/courses/' + ($elm$core$String$fromInt(id) + '/enroll'))
			});
	});
		...
		switch (msg.$) {
			case 'GotCourseData':
				...
				return _Utils_Tuple2(
					_Utils_update(
						...
						{courseData: data}),
					$elm$core$Platform$Cmd$none);
			case 'ChangeTeacherText':
				var text = msg.a;
				var errorMsg = 'please set a teacher';
				return $elm$core$String$isEmpty(
					$elm$core$String$trim(text)) ? (A2($elm$core$List$member, errorMsg, model.createCourseErrors) ? _Utils_Tuple2(
					_Utils_update(
						model,
						{teacherText: text}),
					$elm$core$Platform$Cmd$none) : _Utils_Tuple2(
					_Utils_update(
						model,
						{
							createCourseErrors: _Utils_ap(
								model.createCourseErrors,
								_List_fromArray(
									[errorMsg])),
							teacherText: text
						}),
			...
			case 'CreateCourse':
				return _Utils_Tuple2(
					...
					A3(
						...
						model.subjectText,
						model.teacherText,
						{onResponse: $author$project$Pages$Dashboard$Courses$GotCreateCourseResponse}));
			case 'GotCreateCourseResponse':
				var data = msg.a;
				if (data.$ === 'Success') {
					var course = data.a;
			...
			case 'EnrollInCourse':
				var _v3 = $elm$core$List$head(
					$elm$core$List$reverse(
						A2($elm$core$String$split, '#', model.inviteCodeText)));
				if (_v3.$ === 'Just') {
					var idString = _v3.a;
					...
					if (_v4.$ === 'Just') {
						...
						return _Utils_Tuple2(
							...
							A2(
								...
								id,
								{onResponse: $author$project$Pages$Dashboard$Courses$GotEnrollData}));
					} else {
						return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
					}
				} else {
...
var $author$project$Pages$Dashboard$Courses$ChangeSubjectText = function (a) {
	return {$: 'ChangeSubjectText', a: a};
};
var $author$project$Pages$Dashboard$Courses$ChangeTeacherText = function (a) {
	return {$: 'ChangeTeacherText', a: a};
};
var $author$project$Pages$Dashboard$Courses$CreateCourse = {$: 'CreateCourse'};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$author$project$Pages$Dashboard$Courses$viewCreateCourseFormErrors(model.createCourseErrors),
				A2(
				$mdgriffith$elm_ui$Element$column,
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
										...
										])),
								{
									...
									onChange: $author$project$Pages$Dashboard$Courses$ChangeTeacherText,
										...
										])),
								{
									...
									onChange: $author$project$Pages$Dashboard$Courses$ChangeSubjectText,
									placeholder: $elm$core$Maybe$Nothing,
									text: model.subjectText
								})
							])),
						function () {
						var active = $elm$core$List$isEmpty(model.createCourseErrors);
										...
										]) : _List_Nil)),
							{
								label: A2(
									...
									_List_fromArray(
										[$mdgriffith$elm_ui$Element$centerX, $mdgriffith$elm_ui$Element$centerY]),
									$mdgriffith$elm_ui$Element$text('create course')),
								onPress: $elm$core$List$isEmpty(model.createCourseErrors) ? $elm$core$Maybe$Just($author$project$Pages$Dashboard$Courses$CreateCourse) : $elm$core$Maybe$Nothing
							});
					}()
					]))
			]));
...
var $author$project$Pages$Dashboard$Courses$ChangeInviteCodeText = function (a) {
	return {$: 'ChangeInviteCodeText', a: a};
};
var $author$project$Pages$Dashboard$Courses$EnrollInCourse = {$: 'EnrollInCourse'};
		...
		_List_fromArray(
			[
				...
				$author$project$Pages$Dashboard$Courses$inputStyle,
				{
					...
					onChange: $author$project$Pages$Dashboard$Courses$ChangeInviteCodeText,
					placeholder: $elm$core$Maybe$Nothing,
					text: model.inviteCodeText
				}),
				function () {
				var active = !$elm$core$String$isEmpty(
					$elm$core$String$trim(model.inviteCodeText));
				var bgColor = active ? $author$project$Pages$Dashboard$Courses$blueColor : A2($author$project$Utils$Darken$darken, $author$project$Pages$Dashboard$Courses$lighterGreyColor, -0.1);
				return A2(
					$mdgriffith$elm_ui$Element$Input$button,
					_Utils_ap(
								...
								]) : _List_Nil)),
					{
						...
						onPress: active ? $elm$core$Maybe$Just($author$project$Pages$Dashboard$Courses$EnrollInCourse) : $elm$core$Maybe$Nothing
					});
			}()
			]));
};
...
var $author$project$Pages$Dashboard$Courses$viewCourseRow = function (course) {
	return A2(
		...
		course.fromMoodle ? _List_fromArray(
			[
				$mdgriffith$elm_ui$Element$text(course.name)
			]) : _List_fromArray(
			[
				$mdgriffith$elm_ui$Element$text(course.teacher + (' - ' + course.subject)),
				A2(
				$mdgriffith$elm_ui$Element$el,
				_List_fromArray(
					[$mdgriffith$elm_ui$Element$alignRight]),
				$mdgriffith$elm_ui$Element$text(
					A3($author$project$Pages$Dashboard$Courses$generateInviteCode, course.id, course.teacher, course.subject)))
			]));
};
				...
				A2(
					...
					_List_fromArray(
						[
							$author$project$Components$Sidebar$viewSidebar(
							{
								active: $elm$core$Maybe$Just('courses'),
								courseData: model.courseData,
								device: model.device,
								user: model.user
							}),
							...
							_List_fromArray(
								[
									...
									$author$project$Pages$Dashboard$Courses$viewMyCourses(model.courseData)
								]))
						])))
			]),
...
var $author$project$Pages$Dashboard$Courses$page = $author$project$Spa$Page$application(
	{init: $author$project$Pages$Dashboard$Courses$init, load: $author$project$Pages$Dashboard$Courses$load, save: $author$project$Pages$Dashboard$Courses$save, subscriptions: $author$project$Pages$Dashboard$Courses$subscriptions, update: $author$project$Pages$Dashboard$Courses$update, view: $author$project$Pages$Dashboard$Courses$view});
...
var $author$project$Spa$Generated$Pages$pages = {
	...
	dashboard__courses: A3($author$project$Spa$Generated$Pages$upgrade, $author$project$Spa$Generated$Pages$Dashboard__Courses__Model, $author$project$Spa$Generated$Pages$Dashboard__Courses__Msg, $author$project$Pages$Dashboard$Courses$page),
...
var $author$project$Spa$Generated$Pages$init = function (route) {
	switch (route.$) {
		...
		case 'Dashboard__Courses':
			return $author$project$Spa$Generated$Pages$pages.dashboard__courses.init(_Utils_Tuple0);
		default:
...
var $author$project$Spa$Generated$Pages$bundle = function (bigModel) {
	switch (bigModel.$) {
		...
		case 'Dashboard__Courses__Model':
			var model = bigModel.a;
			return $author$project$Spa$Generated$Pages$pages.dashboard__courses.bundle(model);
		default:
			var model = bigModel.a;
	...
	function (bigMsg, bigModel) {
		...
		while (true) {
			switch (_v0.a.$) {
				...
				case 'Dashboard__Courses__Msg':
					if (_v0.b.$ === 'Dashboard__Courses__Model') {
						var msg = _v0.a.a;
						var model = _v0.b.a;
						return A2($author$project$Spa$Generated$Pages$pages.dashboard__courses.update, msg, model);
					} else {
						break _v0$7;
					}
				default:
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	A2(
		...
		A2($elm$json$Json$Decode$field, 'width', $elm$json$Json$Decode$int)))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{"Url.Url":{"args":[],"type":"{ protocol : Url.Protocol, host : String.String, port_ : Maybe.Maybe Basics.Int, path : String.String, query : Maybe.Maybe String.String, fragment : Maybe.Maybe String.String }"},"Pages.NotFound.Msg":{"args":[],"type":"Basics.Never"},"Pages.Top.Msg":{"args":[],"type":"Basics.Never"},"Models.User":{"args":[],"type":"{ id : Basics.Int, username : String.String, email : String.String, privilege : Models.Privilege, moodleUrl : String.String }"},"Models.Assignment":{"args":[],"type":"{ id : Basics.Int, courseId : Basics.Int, creator : Models.User, title : String.String, description : Maybe.Maybe String.String, dueDate : Date.Date }"},"Models.Course":{"args":[],"type":"{ id : Basics.Int, name : String.String, subject : String.String, teacher : String.String, assignments : List.List Models.Assignment, fromMoodle : Basics.Bool, creator : Basics.Int }"},"Api.Homework.Analytics.CourseAnalyticsData":{"args":[],"type":"( String.String, Basics.Int )"},"Api.Homework.Course.MinimalCourse":{"args":[],"type":"{ id : Basics.Int, name : String.String, subject : String.String, teacher : String.String, fromMoodle : Basics.Bool }"},"Date.RataDie":{"args":[],"type":"Basics.Int"}},"unions":{"Main.Msg":{"args":[],"tags":{"LinkClicked":["Browser.UrlRequest"],"UrlChanged":["Url.Url"],"Shared":["Shared.Msg"],"Pages":["Spa.Generated.Pages.Msg"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Shared.Msg":{"args":[],"tags":{"GotUser":["Api.Data Models.User"],"Logout":[],"Resize":["Basics.Int","Basics.Int"],"GotLogoutData":["Result.Result Http.Error ()"]}},"Spa.Generated.Pages.Msg":{"args":[],"tags":{"Top__Msg":["Pages.Top.Msg"],"Dashboard__Msg":["Pages.Dashboard.Msg"],"Login__Msg":["Pages.Login.Msg"],"NotFound__Msg":["Pages.NotFound.Msg"],"Register__Msg":["Pages.Register.Msg"],"Dashboard__Courses__Msg":["Pages.Dashboard.Courses.Msg"],"Dashboard__Moodle__Msg":["Pages.Dashboard.Moodle.Msg"]}},"Url.Protocol":{"args":[],"tags":{"Http":[],"Https":[]}},"String.String":{"args":[],"tags":{"String":[]}},"Browser.UrlRequest":{"args":[],"tags":{"Internal":["Url.Url"],"External":["String.String"]}},"Api.Data":{"args":["value"],"tags":{"NotAsked":[],"Loading":[],"Failure":["Http.Error"],"Success":["value"]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String.String"],"Timeout":[],"NetworkError":[],"BadStatus":["Basics.Int"],"BadBody":["String.String"]}},"Pages.Dashboard.Msg":{"args":[],"tags":{"GotCourseData":["Api.Data (List.List Models.Course)"],"GotCourseAnalyticsData":["Api.Data (List.List Api.Homework.Analytics.CourseAnalyticsData)"],"ViewMoreAssignments":[],"SearchCourses":["String.String"],"GotSearchCoursesData":["Api.Data (List.List Api.Homework.Course.MinimalCourse)"],"CAFSelectCourse":["Api.Homework.Course.MinimalCourse"],"CAFChangeTitle":["String.String"],"CAFChangeDate":["String.String"],"CreateAssignment":[],"GotCreateAssignmentData":["Api.Data Models.Assignment"],"ReceiveTime":["Time.Posix"],"Add1Day":[]}},"Pages.Dashboard.Courses.Msg":{"args":[],"tags":{"GotCourseData":["Api.Data (List.List Models.Course)"],"ChangeTeacherText":["String.String"],"ChangeSubjectText":["String.String"],"CreateCourse":[],"GotCreateCourseResponse":["Api.Data Models.Course"],"ChangeInviteCodeText":["String.String"],"EnrollInCourse":[],"GotEnrollData":["Api.Data Models.User"]}},"Pages.Dashboard.Moodle.Msg":{"args":[],"tags":{"ChangeMoodleUrlInput":["String.String"],"GotSiteData":["Api.Data String.String"],"ChangeMoodleUsernameInput":["String.String"],"ChangeMoodlePasswordInput":["String.String"],"Authenticate":[],"GotAuthenticationData":["Api.Data Models.User"]}},"Pages.Login.Msg":{"args":[],"tags":{"UsernameInput":["String.String"],"PasswordInput":["String.String"],"GotLoginData":["Api.Data Models.User"],"Login":[]}},"Pages.Register.Msg":{"args":[],"tags":{"UsernameInput":["String.String"],"PasswordInput":["String.String"],"ValidatePasswordInput":["String.String"],"EmailInput":["String.String"],"GotUsernameTaken":["Api.Data Basics.Bool"],"GotRegistrationData":["Api.Data Models.User"],"Register":[]}},"Basics.Never":{"args":[],"tags":{"JustOneMore":["Basics.Never"]}},"Models.Privilege":{"args":[],"tags":{"Normal":[],"Admin":[]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"Basics.Bool":{"args":[],"tags":{"True":[],"False":[]}},"Date.Date":{"args":[],"tags":{"RD":["Date.RataDie"]}},"List.List":{"args":["a"],"tags":{}},"Time.Posix":{"args":[],"tags":{"Posix":["Basics.Int"]}}}}})}});}(this));